...
QT_MOC_LITERAL(4, 25, 4) // "type"
    ...
    "AudioThread\0doPlay\0\0play\0type"
};
...
void AudioThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (AudioThread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AudioThread::doPlay)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject AudioThread::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_AudioThread.data,
